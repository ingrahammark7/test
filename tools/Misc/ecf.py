...
def create_pdf(output_filename):
    ...
    intro_text = [
        ...
        "2. Account will be used to file documents on PACER.",
              "3. Court attempted to grant motion in previous case but I recieved error about non attourney litigants"," not allowed on pacer.gov efile permission request.",
              "4. ECF help desk was informed of error and seems unable to resolve.",
        ]
    y_position -= 1*inch
    ...
    c.drawString(left_margin, y_position - 1 * inch, "Mark Ingraham, 8/31/2025")
