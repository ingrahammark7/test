...
def create_pdf(output_filename):
    ...
    c.setFont("Times-Roman",12)
    intro_text = "I have submitted a request to proceed in forma pauperis. I request that a US Marshall serve the filed summons and petition to defendant. If service by marshall is not possible, case will be appealed. /n" 
    y_position -= .25*inch
