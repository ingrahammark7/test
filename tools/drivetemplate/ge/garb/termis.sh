...
pip install yt-dlp setuptools youtube-dl gallery-dl beautifulsoup4 build reportlab sympy pypdf2 poppler ghostscript mps-youtube black pyautogui pynput pywinauto pygetwindow uiautomator kivy kivy3 
